...
struct RegisterView: View {
    ...
    var formSection: some View {
        Group {
            ...
            fieldView(icon: "envelope.fill", title: "Email", placeholder: "Masukkan alamat email", text: $viewModel.user.email, isSecure: false, keyboard: .emailAddress)
    ...
    func fieldView(icon: String, title: String, placeholder: String, text: Binding<String>, isSecure: Bool, keyboard: UIKeyboardType = .default) -> some View {
        VStack(alignment: .leading, spacing: 8) {
            HStack {
